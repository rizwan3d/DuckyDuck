...
- **Application** refers to DuckyDuck - Ducky Bhai In Game, the software program provided by the Company.
- **Company** (referred to as either "the Company", "We", "Us", or "Our" in this Agreement) refers to DuckyDuck - Ducky Bhai In Game.
